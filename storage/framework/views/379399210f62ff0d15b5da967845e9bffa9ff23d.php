...
<div id='app' class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="<?php echo e(url(config('crudbooster.ADMIN_PATH'))); ?>" title='<?php echo e(Session::get('appname')); ?>'
                       class="navbar-brand"><?php echo e(CRUDBooster::getSetting('appname')); ?></a>
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            Powered By <?php echo e(Session::get('appname')); ?>
