    ...
    <?php else: ?> 
      ...
      <?php endif; ?>
		...
		<div class="pull-right">
           ...
           href='/saga/complaints/edit/<?php echo e($row->id); ?>'><i
          ...
          <a class='btn btn-xs btn-warning btn-delete' title='Delete' href='javascript:;'
           onclick='swal({   
				...
				function(){  location.href="/saga/complaints/delete/<?php echo e($row->id); ?>" });'><i class='fa fa-trash'></i>Delete</a>
          <?php endif; ?>
...
<?php if(CRUDBooster::myPrivilegeName()=="Admin staff"): ?>
   <form method="post" action="<?php echo e(action('ReplaysController@store')); ?>">
          
              <?php echo csrf_field(); ?>
              <input type="hidden" name="user_id" value="<?php echo e(CRUDBooster::myId()); ?>">
              <input type="hidden" name="complaints_id" value="<?php echo e($posts['complain']->id); ?>">
...
<?php $__currentLoopData = $posts['comments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 <div class="pull-left">
    ...
    <?php else: ?> 
      ...
      <?php endif; ?>
            <?php endif; ?>
              <div style="float: right;margin-left:5px" ><strong><a style="color: #2874A6" href="#"><?php echo e($row->cms_users->name); ?></a></strong>
               
                <div >
                  <p style="margin-left:12px"><?php echo e($row->content); ?></p></div><div>
                  <span class="time_date"><?php echo e($row->created_at->diffForHumans()); ?></span></div>
</div>
...
<p><?php echo urldecode(str_replace("/?","?",$posts['comments']->appends(Request::all())->render())); ?></p>
<?php endif; ?>
</div>
						</div><br><br>
