<div class='form-group peta <?php echo e($header_group_class); ?> <?php echo e(($errors->first($name))?"has-error":""); ?>'>
    ...
    <div class="<?php echo e($col_width?:'col-sm-10'); ?>">
        ...
        <div class="input-group">
            <input type="text" class="form-control" id="<?php echo e($name); ?>" <?php echo e(($readonly)?"readonly":""); ?> <?php echo e(($required)?"required":""); ?> value="<?php echo e($value); ?>"
            ...
            <span class="input-group-btn">
						        <button class="btn btn-primary" onclick="showMapModal<?php echo e($name); ?>()" type="button"><i
