<?php namespace App\Http\Controllers;
	...
	class AdminComplaintsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Cms Users_id","name"=>"cms_users_id"];
	    ...
	    */
	    public function hook_after_add($id) {        
	        //Your code here
	         redirect('/saga/viewcomplaints')->with(['message'=>'message text','message_type'=>'info'])->send(); 
