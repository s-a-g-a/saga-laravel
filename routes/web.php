...
Route::post("/saga/complaints/replys", ['uses' => 'ReplaysController@store']);
...
Route::get('/saga/curriculum', ['uses' => 'viewsController@getCurriculum', 'as' => 'getCurriculum']);
    ...
    Route::get("/saga/viewcomplaints/replys/".'{id}', ['uses' => 'ReplaysController@show', 'as' => 'cond']);

    Route::get("/saga/evaluate", ['uses' => 'viewsController@evaluate', 'as' => 'cond']);